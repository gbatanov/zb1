## V4.1 Работа с ультразвуковым датчиком напрямую без arduino с использованием аппаратного таймера

v4.1 - попытка обойтись без ардуино.
Вариант очень нестабильный и неточный. Отказался от него.
