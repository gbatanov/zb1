...
void set_attribute()
{
    ...
    if (connected)
    {
        ...
        report_attr_cmd2.attributeID = ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_VALUE_ID;
        report_attr_cmd2.direction = ESP_ZB_ZCL_CMD_DIRECTION_TO_CLI;
        report_attr_cmd2.clusterID = ESP_ZB_ZCL_CLUSTER_ID_PRESSURE_MEASUREMENT;
        report_attr_cmd2.zcl_basic_cmd.src_endpoint = ZB1_ENDPOINT_1;
        report_attr_cmd2.zcl_basic_cmd.dst_addr_u.addr_short = 0;
        report_attr_cmd2.zcl_basic_cmd.dst_endpoint = 1;

        err = esp_zb_zcl_report_attr_cmd_req(&report_attr_cmd2);
        esp_zb_lock_release();
...
void esp_zb_task(void *pvParameters)
{
    ...
    // Pressure cluster
    int16_t undefined_valueP, value_minP, value_maxP;
    undefined_valueP = 0x8000;
    value_minP = 0x8001;
    value_maxP = 0x7ffe; // 32766
    ...
    esp_zb_pressure_meas_cluster_add_attr(esp_zb_pressure_meas_cluster, ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_VALUE_ID, &undefined_valueP);
    esp_zb_pressure_meas_cluster_add_attr(esp_zb_pressure_meas_cluster, ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MIN_VALUE_ID, &value_minP);
    esp_zb_pressure_meas_cluster_add_attr(esp_zb_pressure_meas_cluster, ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MAX_VALUE_ID, &value_maxP);
    ...
    esp_zb_cluster_list_add_pressure_meas_cluster(esp_zb_cluster_list,
                                                  esp_zb_pressure_meas_cluster,
                                                  ESP_ZB_ZCL_CLUSTER_SERVER_ROLE);
