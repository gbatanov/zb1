...
void temp_chip_task(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        temperature8 = (uint8_t)tsens_value;
        temperature = (uint16_t)tempInt16;

        ESP_LOGI(TAG, "Temperature value %.02f %d ℃", tsens_value, temperature8);
