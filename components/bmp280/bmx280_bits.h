...
{
    BMX280_MODE_SLEEP = 0, // Sensor does no measurements.
    BMX280_MODE_FORCE = 1, // Sensor is in a forced measurement cycle. Sleeps after finishing.
    BMX280_MODE_CYCLE = 3, // Sensor does measurements. Never sleeps.
} bmx280_mode_t;
